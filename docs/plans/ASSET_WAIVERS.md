# Asset waivers — IbrahimOS Cloud Grant demo

**Updated:** August 1, 2026  
**Rule:** No fabricated certificates, founders, logos, or traction media.
...
## Written owner waivers

_(None yet for demo.mp4.)_

Re-run: `pnpm cac` after replacing the PDF · `pnpm shots` with `npm run dev` up.
