...
export default function AccountPage() {
  ...
  return (
    <main className="px-4 py-8 sm:px-6">
      ...
      <p className="mt-1 text-sm text-ink-muted">Profile and plan for the Kaduna command desk</p>
      ...
      <div className="mt-8 max-w-lg space-y-4 border border-line bg-bg-elevated p-6">
        ...
        <div>
          ...
          <p className="mt-1 text-sm font-medium text-ink">North Block 04 · Kaduna</p>
        </div>
        <div>
          <p className="text-xs font-semibold uppercase tracking-wider text-ink-muted">
            Plan
